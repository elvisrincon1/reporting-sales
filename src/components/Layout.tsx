...
import { FileText, ShoppingBag, Users, User, BarChart3, LayoutDashboard } from 'lucide-react';
          ...
          <SidebarContent>
            ...
            <SidebarGroup>
              ...
              <SidebarGroupContent>
                <SidebarMenu>
                  <SidebarMenuItem>
                    <SidebarMenuButton asChild className={isActive('/dashboard') ? 'bg-primary/10 text-primary' : ''}>
                      <Link to="/dashboard">
